  ...
  profile: {
    ...
    climbingSteps: [
      ...
      },
      {
        ...
        title: "Product Designer toàn diện",
        year: "Tương lai",
        altitude: "3000m",
        desc: "Không chỉ thiết kế giao diện, hướng tới quản trị sản phẩm toàn diện từ công nghệ, thiết kế đến chiến lược vận hành, liên tục chinh phục những đỉnh cao mới."
      }
    ]
  },
  projects: [
